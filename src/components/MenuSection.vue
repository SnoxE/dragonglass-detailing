...
export default {
  ...
  data() {
    return {
      items: [
        { name: 'Mycie Ręczne', url: '#' },
        { name: 'Woskowanie', url: '#' },
        { name: 'Korekta Lakieru', url: '#' },
        { name: 'Zabezpieczenie PPF', url: '#' },
        { name: 'Powłoka Ceramiczna', url: '#' },
        { name: 'Czyszczenie Wnętrza', url: '#' },
        { name: 'Przyciemnianie Szyb', url: '#' }
      ]
    }
  }
}
