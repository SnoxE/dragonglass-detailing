...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/slots/generateSlots.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/slots/getAvailableSlots.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/slots/filterSlots.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/front/axios.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/front/axios usage.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{jpg/front/router.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{jpg/manual/homepage.jpg}
    \caption{Strona startowa aplikacji}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{jpg/manual/aboutsection.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/manual/contactsection.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{jpg/manual/userdropdown.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/manual/menusection.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/manual/loginpage.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{jpg/manual/registerpage.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{jpg/manual/profilepage.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/manual/carspage.jpg}
    \caption{Lista wszystkich samochodów użytkownika}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{jpg/manual/addcar.jpg}
    \caption{Lista wszystkich samochodów użytkownika}
\end{figure}
